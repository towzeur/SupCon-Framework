...
if __name__ == "__main__":
    ...
    shutil.rmtree(
        "runs/{}".format(logging_name), ignore_errors=True,
    )
    shutil.rmtree(
        "logs/{}".format(logging_name), ignore_errors=True,
    )
    os.makedirs(
        "logs/{}".format(logging_name), exist_ok=True,
    )
    ...
    for epoch in range(n_epochs):
        ...
        if valid_metrics[target_metric] > metric_best:
            ...
            os.makedirs(
                "weights/{}".format(logging_name), exist_ok=True,
            )
